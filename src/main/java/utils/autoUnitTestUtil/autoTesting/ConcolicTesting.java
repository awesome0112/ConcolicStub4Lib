...
public class ConcolicTesting {
    ...
    private static ConcolicTestResult startGenerating(ConcolicAUTController.Coverage coverage) throws IllegalAccessException, ClassNotFoundException, NoSuchFieldException, IOException, InterruptedException {
